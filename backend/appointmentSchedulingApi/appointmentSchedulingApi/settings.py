"""
Django settings for appointmentSchedulingApi project.
...
ROOT_URLCONF = 'appointmentSchedulingApi.urls'
...
WSGI_APPLICATION = 'appointmentSchedulingApi.wsgi.application'
